...
|:---------------|----------------|--------------------|--------------------|------------|
| 一つ | `map()` | `map_lgl()`, `map_chr()`, `map_dbl()`, `map_int()` | `modify()` | `walk()` |
| 二つ | `map2()` | `map2_lgl()`, `map2_chr()`, `map2_dbl()`, `map2_int()` | `modify2()` | `walk2()` |
| 一つ + インデックス | `imap()` | `imap_lgl()`, `imap_chr()`, `imap_dbl()`, `imap_int()` | `imodify()` | `iwalk()` |
| 任意 | `pmap()` | `pmap_lgl()`, `pmap_chr()`, `pmap_dbl()`, `pmap_int()` | - | `pwalk()` |
